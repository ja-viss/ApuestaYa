...
/**
 * Página dedicada a los archivos y scripts de Lotería.
 * 
 * Características:
 * - Carga dinámica desde Firestore.
 * - Filtrado por categoría 'lottery'.
  ...
  return (
    <div className="max-w-7xl mx-auto px-6 py-20">
      ...
      <div className="flex items-center gap-4 mb-12">
        ...
        <div>
          <h1 className="text-5xl font-black uppercase italic leading-none">Archivos de Lotería</h1>
          <p className="text-purple-200 font-bold tracking-widest text-xs uppercase mt-1">Scripts y formatos de carga</p>
        </div>
      </div>
